...
// y lo guarda en la variable operadores
        ...
        operadores.operadoresAritmeticos(); //Una vez tienes el objeto, puedes usar sus metodos
        //operadores es el objeto creado, mientras que,
        // operadores.aritmeticos es el metodo dentro de la clase
        //significa: llama al metodo operadores.aritmeticos del objeto ooperadiores
